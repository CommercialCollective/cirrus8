...
if __name__ == "__main__":
    try:
        ...
        if len(sys.argv) == expected_argument_count:
            ...
            cityscope_user_secret_name = os.environ["CITYSCOPE_USER_SECRET_NAME"]
            ...
            cityscope_username_secret = secret_client.get_secret(
                cityscope_user_secret_name
            )

            username = cityscope_username_secret.value
            print(username)
        else:
            print(
