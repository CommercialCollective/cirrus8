...
if __name__ == "__main__":
    try:
        ...
        if len(sys.argv) == expected_argument_count:
            ...
            cirrus8_reports_password_secret_name = os.environ[
                "REPORTS_PASSWORD_SECRET_NAME"
            ]
            ...
            cirrus8_password_secret = secret_client.get_secret(
                cirrus8_reports_password_secret_name
            )

            password = cirrus8_password_secret.value
            print(password)
        else:
            print(
